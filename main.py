...
questions_list.append(
        Question('Какая форма глагола to be используется в present continious, единственное число?', 'is', 'were', 'did', 'do'))
questions_list.append(
        Question('Большинство информации которую мы получаем - ...', 'визуальная', 'тактильная', 'аудиальная', 'обонятельная'))
questions_list.append(
        Question('Кто написал войну и мир?', 'Л. Н. Толстой', 'А. Н. Толстой', 'Маяковский', 'Пушкин'))
questions_list.append(
        Question('Какой сейчас год?', '2022', '2019', '2017', '2023'))
questions_list.append(
        Question('Кто открыл закон всемирного тяготения?', 'И. Ньютон', 'В. К. Рёнтген', 'Р. Браун', 'Н. Тесла'))
questions_list.append(
        Question('В каких суффиксах пишется "нн"?', '-енн-', '-анн-', '-янн-', '-инн-'))
questions_list.append(
        Question('Как пишется п??п??д?кулярный', 'перпендикулярный', 'пинпиндекулярный', 'пенпендикулярный', 'перпиндикулярный'))
...
print('---------всего может встретится 10 различных вопросов. Попробуй найти и ответить все вопросы---------')
window = QWidget()
